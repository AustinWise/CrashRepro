...
inline static DWORD64 CONTEXTGetPC(LPCONTEXT pContext)
{
    ...
    return pContext->Pc;
#else
#error dont know how to get the program counter for this architecture
#endif
}
...
inline static void CONTEXTSetPC(LPCONTEXT pContext, DWORD64 pc)
{
    ...
    pContext->Pc = pc;
#else
#error dont know how to set the program counter for this architecture
#endif
}
...
inline static DWORD64 CONTEXTGetFP(LPCONTEXT pContext)
{
    ...
    return pContext->Fp;
#else
#error dont know how to get the frame pointer for this architecture
#endif
}
